...
if __name__ == "__main__":
    ...
    configurations = [
        {
            "params": {"QUEUE_DEPTH": 8, "ROB_DEPTH": 8, "RESERVATION_STATION_SIZE": 4, "LS_QUEUE_DEPTH": 4},
            "commands": [
        ...
        {
            "params": {"QUEUE_DEPTH": 8, "ROB_DEPTH": 16, "RESERVATION_STATION_SIZE": 4, "LS_QUEUE_DEPTH": 4},
            "commands": [
                "make run_vcs_top_tb PROG=../testcode/coremark_im.elf",
                "make run_vcs_top_tb PROG=../testcode/additional_testcases/compression_im.elf",
                "make run_vcs_top_tb PROG=../testcode/cp3_release_benches/mergesort.c",
        ...
        {
            "params": {"QUEUE_DEPTH": 16, "ROB_DEPTH": 8, "RESERVATION_STATION_SIZE": 4, "LS_QUEUE_DEPTH": 4},
            "commands": [
                "make run_vcs_top_tb PROG=../testcode/coremark_im.elf",
                "make run_vcs_top_tb PROG=../testcode/additional_testcases/compression_im.elf",
                "make run_vcs_top_tb PROG=../testcode/cp3_release_benches/mergesort.c",
        ...
        {
            "params": {"QUEUE_DEPTH": 16, "ROB_DEPTH": 16, "RESERVATION_STATION_SIZE": 4, "LS_QUEUE_DEPTH": 4},
            "commands": [
                "make run_vcs_top_tb PROG=../testcode/coremark_im.elf",
                "make run_vcs_top_tb PROG=../testcode/additional_testcases/compression_im.elf",
                "make run_vcs_top_tb PROG=../testcode/cp3_release_benches/mergesort.c",
        ...
        {
            "params": {"QUEUE_DEPTH": 8, "ROB_DEPTH": 8, "RESERVATION_STATION_SIZE": 8, "LS_QUEUE_DEPTH": 4},
            "commands": [
                "make run_vcs_top_tb PROG=../testcode/coremark_im.elf",
                "make run_vcs_top_tb PROG=../testcode/additional_testcases/compression_im.elf",
                "make run_vcs_top_tb PROG=../testcode/cp3_release_benches/mergesort.c",
        ...
        {
            "params": {"QUEUE_DEPTH": 8, "ROB_DEPTH": 16, "RESERVATION_STATION_SIZE": 8, "LS_QUEUE_DEPTH": 4},
            "commands": [
                "make run_vcs_top_tb PROG=../testcode/coremark_im.elf",
                "make run_vcs_top_tb PROG=../testcode/additional_testcases/compression_im.elf",
                "make run_vcs_top_tb PROG=../testcode/cp3_release_benches/mergesort.c",
        ...
        {
            "params": {"QUEUE_DEPTH": 16, "ROB_DEPTH": 16, "RESERVATION_STATION_SIZE": 8, "LS_QUEUE_DEPTH": 4},
            "commands": [
                "make run_vcs_top_tb PROG=../testcode/coremark_im.elf",
                "make run_vcs_top_tb PROG=../testcode/additional_testcases/compression_im.elf",
                "make run_vcs_top_tb PROG=../testcode/cp3_release_benches/mergesort.c",
        ...
        {
            "params": {"QUEUE_DEPTH": 8, "ROB_DEPTH": 8, "RESERVATION_STATION_SIZE": 4, "LS_QUEUE_DEPTH": 8},
            "commands": [
                "make run_vcs_top_tb PROG=../testcode/coremark_im.elf",
                "make run_vcs_top_tb PROG=../testcode/additional_testcases/compression_im.elf",
                "make run_vcs_top_tb PROG=../testcode/cp3_release_benches/mergesort.c",
        ...
        {
            "params": {"QUEUE_DEPTH": 8, "ROB_DEPTH": 8, "RESERVATION_STATION_SIZE": 8, "LS_QUEUE_DEPTH": 8},
            "commands": [
                "make run_vcs_top_tb PROG=../testcode/coremark_im.elf",
                "make run_vcs_top_tb PROG=../testcode/additional_testcases/compression_im.elf",
                "make run_vcs_top_tb PROG=../testcode/cp3_release_benches/mergesort.c",
        ...
        {
            "params": {"QUEUE_DEPTH": 16, "ROB_DEPTH": 16, "RESERVATION_STATION_SIZE": 8, "LS_QUEUE_DEPTH": 8},
            "commands": [
                "make run_vcs_top_tb PROG=../testcode/coremark_im.elf",
                "make run_vcs_top_tb PROG=../testcode/additional_testcases/compression_im.elf",
                "make run_vcs_top_tb PROG=../testcode/cp3_release_benches/mergesort.c",
        ...
        {
            "params": {"QUEUE_DEPTH": 16, "ROB_DEPTH": 16, "RESERVATION_STATION_SIZE": 16, "LS_QUEUE_DEPTH": 16},
            "commands": [
                "make run_vcs_top_tb PROG=../testcode/coremark_im.elf",
                "make run_vcs_top_tb PROG=../testcode/additional_testcases/compression_im.elf",
                "make run_vcs_top_tb PROG=../testcode/cp3_release_benches/mergesort.c",
